...
if __name__ == '__main__':
    ...
    optimizer = PortfolioOptimization(
        transaction_fee=0.003, last_weight=False, vectorize=False, tag="dax_sharpe")
    optimizer.train_model(train_data,
                          ...
                          model_name="ppo",
                          window_size=21,
                          args={'n_steps': 256, 'ent_coef': 0.01,
                                'learning_rate': 0.00025, 'batch_size': 128},
                          iterations=1000_000)
    # model = optimizer.load_from_file(
    #     'ppo', path="data\ppo_close_log_return_volatility_window_size_21_0.003_zzzz\ppo_370000_steps")
    # test_result = optimizer.DRL_prediction(
    #     model, train_data, ["close", "log_return", "volatility"], t=21)
