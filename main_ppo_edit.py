...
cleaned_data['r_21_normal'] = cleaned_data['price_lag_21'] / \
    (cleaned_data['std_return_60'])
cleaned_data['r_42_normal'] = cleaned_data['price_lag_42'] / \
    (cleaned_data['std_return_60'])
cleaned_data['r_63_normal'] = cleaned_data['price_lag_63'] / \
    (cleaned_data['std_return_60'])
cleaned_data['r_252_normal'] = cleaned_data['price_lag_252'] / \
    (cleaned_data['std_return_60'])
...
optimizer = PortfolioOptimization(
    ...
    tag="portfolio_return_ppo", sharp_reward=False, last_weight=False, remove_close=True,
    add_cash=False, env=PortfolioOptimizationEnv
)
optimizer.train_model(train_data,
                      validation_data,
                      features=["close", "log_return", "r_21_normal",
                                "r_42_normal", "r_63_normal", "r_252_normal", "macd", "rsi"
                                ],
                      model_name="ppo",
                      args={"n_steps":  512, "batch_size": 128, 'learning_rate': linear_schedule(2e-4),
