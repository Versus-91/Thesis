...
def plot_dendrogram(hrp, ax=None, show_tickers=True, **kwargs):
    ...
    if show_tickers:
        sch.dendrogram(hrp.clusters, labels=hrp.tickers,
...
def _plot_cla(cla, points, ax, show_assets, show_tickers):
    ...
    ax.scatter(optimal_risk, optimal_ret, marker="x",
               s=100, color="r", label="optimal")
...
def plot_efficient_frontier(
    ...
    **kwargs
    ...
    if isinstance(opt, CLA):
        ...
        raise NotImplementedError(
            "Please pass EfficientFrontier or CLA object")
