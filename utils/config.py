...
DQN_PARAMS = {
    ...
    "train_freq": 4,  # Frequency of updates (in steps)
    "gradient_steps": 1,  # Gradient steps per training step
    "optimize_memory_usage": False,  # Optimize memory for large replay buffers
    "target_update_interval": 10000,  # Interval to update the target network
    "exploration_fraction": 0.1,  # Fraction of training to decay epsilon
